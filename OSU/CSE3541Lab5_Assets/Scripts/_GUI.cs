...
/// <summary>
/// The following code are largely copied from https://stackoverflow.com/questions/58441744/how-to-enable-disable-a-list-in-unity-inspector-using-a-bool.
/// They have no practical usage in game logic, it only helps to manage the inspector UI for faster tunning.
/// </summary>
...
namespace ChenAmarth
{
    ...
    public class ShowIfAttributeDrawer : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            else if (showIfAttribute.Action == ActionOnConditionFail.DisableOnly)
            {
